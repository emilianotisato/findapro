    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <button type="button" onclick="window.location.href='/admin/providers/'"
                    class="block rounded-md
      bg-indigo-600 px-3 py-2 text-center text-sm font-semibold
      text-white shadow-sm hover:bg-indigo-500 focus-visible:outline 
      focus-visible:outline-2 focus-visible:outline-offset-2
      focus-visible:outline-indigo-600">Home</button>
            </div>
        </div>
        ...
        <div class="mt-8 container max-w-2xl m-auto">
            ...
            <form action="{{ route('providers.update', $provider->id) }}" method="post" class="">
                ...
                <div>
                    ...
                    @if ($errors->has('contact_name'))
                        <p class="mt-2 text-sm text-red-600" id="contact-name-error">{{ $errors->first('contact_name') }}</p>
                    @endif
                </div>
